...
import com.example.Slipper.dto.reviewDto.ReviewCreateDto;
...
public class ReviewCreate {
    ...
    public String reviewCreate(@SessionAttribute(name = "id", required = false) String id, Model model) {
    ...
    // 일반 홍보 게시글 등록
    @PostMapping("/review/create/save")
    public String reviewCreateSave(ReviewCreateDto reviewForm, @SessionAttribute(name = "id", required = false) String id, Model model) {
        ...
        if (loginEntre != null || loginUser != null) {
            ...
            model.addAttribute("id", true);
            log.info(_FilePath);
            ReviewBoard reviewBoard = reviewForm.toEntity(id);
    ...
    @RequestMapping(value = "/review/Create/save/smarteditorMultiImageUpload")
